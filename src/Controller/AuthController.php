...
class AuthController extends AbstractController
{
    ...
    public function redirectUser(): Response
    {
        ...
        if (in_array('ROLE_FORMATEUR', $roles)) return $this->redirectToRoute('app_formateur_dashboard'); 
        if (in_array('ROLE_RECRUTEUR', $roles)) return $this->redirectToRoute('app_recruteur_dashboard'); 
        if (in_array('ROLE_CHEF_PROJET', $roles)) return $this->redirectToRoute('app_home'); 
