 ...
 */
final class Version20260413134135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD google_authenticator_secret VARCHAR(255) DEFAULT NULL, ADD is_google_authenticator_enabled TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamations ADD CONSTRAINT FK_1CAD6B76A76ED395 FOREIGN KEY (user_id) REFERENCES utilisateurs (id)');
        $this->addSql('ALTER TABLE utilisateurs DROP google_authenticator_secret, DROP is_google_authenticator_enabled');
    }
}
